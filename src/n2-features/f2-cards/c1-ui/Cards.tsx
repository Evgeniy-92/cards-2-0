...
import {addCard, changeSearchName, setPage, setRowsPerPage} from "../c2-bll/cardsReducer";
...
const Cards = () => {
    ...
    return (
        <div className={styles.main}>
            <FindTable namePage={packName} nameBtn={'Add card'} addElement={addNewCard} changeName={onChangeHandler}/>
            <TableCards/>
            <Paginate totalCount={cardTotalCount} page={page} rowsPerPage={rowsPerPage} setPage={setPage} setRowsPerPage={setRowsPerPage}/>
        </div>
    );
};
